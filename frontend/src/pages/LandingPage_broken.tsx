...
const staticSections: Section[] = [
  ...
  { 
    ...
    description: 'Self-care and community engagement for healthcare providers',
    icon: Heart,
    questionCount: 29,
    difficulty: 'Foundational',
  ...
  { 
    ...
    description: 'Evidence-based nutritional interventions and dietary counseling',
    icon: Activity,
    questionCount: 61,
    difficulty: 'Advanced',
  ...
  { 
    ...
    description: 'Exercise prescription and movement-based interventions',
    icon: Shield,
    questionCount: 43,
    difficulty: 'Intermediate',
  ...
  { 
    ...
    description: 'Psychological well-being and stress management strategies',
    icon: Moon,
    questionCount: 37,
    difficulty: 'Advanced',
  ...
  { 
    ...
    description: 'Sleep optimization and circadian rhythm management',
    icon: Leaf,
    questionCount: 33,
    difficulty: 'Intermediate',
  ...
  { 
    ...
    shortName: 'Tobacco & Toxins',
    description: 'Substance cessation and environmental health considerations',
    icon: GraduationCap,
    questionCount: 28,
    difficulty: 'Intermediate',
...
export const LandingPage = () => {
  ...
  useEffect(() => {
    if (!isLoadingStats && realSections.length > 0) {
      setSelectedSections(realSections.map(s => s.id));
      setSelectedTypes(questionTypes.map(t => t.id));
    }
  }, [realSections, questionTypes, isLoadingStats]);
